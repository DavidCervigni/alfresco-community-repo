...
{
    private static final Log logger = LogFactory.getLog(TransactionUtil.class);
        ...
        boolean readOnly)
    {
        ...
        final UserTransaction txn = nonPropagatingUserTransaction ?
                                    transactionService.getNonPropagatingUserTransaction() :
                                    transactionService.getUserTransaction(readOnly);
        ...
        try
        {
            ...
            // transaction
            txn.begin();
            final R result = transactionWork.doWork();
            // rollback or commit
